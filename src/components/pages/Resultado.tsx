...
export function Result() {
  ...
  return (
    <div className="min-h-full bg-slate-50 flex flex-col items-center justify-center py-6 px-4">
      {/* Botón Volver */}
      <div className="w-full max-w-md mb-6">
        <button
          onClick={() => navigate('/')}
          className="flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 rounded-2xl text-[10px] font-black text-slate-500 hover:text-indigo-600 transition-all shadow-sm tracking-widest"
        >
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-[3rem] p-10 shadow-xl relative overflow-hidden">
        ...
        <h3 className="text-[10px] font-black uppercase text-indigo-500 tracking-[0.3em] mb-10 flex items-center gap-3">
        ...
        <div className="space-y-10">
          {/* Foto de la captura */}
          <div className="aspect-video rounded-[2rem] bg-slate-50 border border-slate-100 overflow-hidden shadow-inner">
          ...
          <div className="px-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm font-black text-indigo-600">{state.confidence}%</span>
            </div>
            <div className="h-2.5 w-full bg-slate-100 rounded-full overflow-hidden">
              <div className="h-full bg-indigo-500 shadow-[0_0_15px_rgba(99,102,241,0.4)]" style={{ width: `${state.confidence}%` }}></div>
            </div>
          </div>
